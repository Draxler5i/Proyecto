...
const postUser = async (user: { name:string, age:number, email:string, password:string, birthday:Date, created:Date, lastname:string },
...
const updateUser = async (user: { name?:string, age?:number, email?:string, password?:string, birthday?:Date, lastname?:string, id:number }) => {
    try {
