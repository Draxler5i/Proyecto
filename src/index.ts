...
app.get('/saldo', auth, services.getSaldo)
app.get('/details', auth, services.getDetails)
app.get('/details/:id', auth, services.getDetailsById)
app.get('/sells/:id', auth, services.getSellsByUserId)
app.post('/users', auth, services.createUser)
app.post('/ticket', auth, services.createTicket)
app.post('/stadium', auth, services.createStadium)
app.post('/sells', auth, services.createSell)
app.post('/sells', auth, services.createDetail)
